...
namespace TheCatToy {
    ...
    MyServo     servoX      (SERVO1,    60,    120,   (random(1.0,10.0)/100.0));
    MyServo     servoY      (SERVO2,    25,    50,    (random(1.0,10.0)/100.0));
    ...
    class CatLaser {
        ...
        public:
            ...
            void autoMove() {
                ...
                int diceRollPause = random(0,random(10,50));
                if (diceRollPause == 0){
                    delay(random(250, 1750));
                }
//                else if (diceRollPause == 1) {
//                    servoX.servoDirection *= -1;
//                }
//                else if (diceRollPause == 2) {
//                    servoY.servoDirection *= -1;
//                }

                delay(70);  // let the servo breath...
